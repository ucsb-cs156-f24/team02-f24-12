...
public class MenuItemReviewWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_menuitemreview() throws Exception {
        ...
        page.getByTestId("MenuItemReviewForm-dateReviewed").fill("2023-10-01T12:00");
        page.getByTestId("MenuItemReviewForm-comments").fill("Delicious and well-presented!");
        page.getByTestId("MenuItemReviewForm-submit").click();

        assertThat(page.getByTestId("MenuItemReviewTable-cell-row-0-col-comments"))
                .hasText("Delicious and well-presented!");
        ...
        page.getByTestId("MenuItemReviewForm-comments").fill("Absolutely fantastic!");
        page.getByTestId("MenuItemReviewForm-submit").click();

        assertThat(page.getByTestId("MenuItemReviewTable-cell-row-0-col-comments"))
                .hasText("Absolutely fantastic!");
