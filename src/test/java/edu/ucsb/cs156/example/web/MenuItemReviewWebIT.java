...
public class MenuItemReviewWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_menu_item_review() throws Exception {
        ...
        page.getByTestId("MenuItemReviewForm-itemId").fill("123");
        page.getByTestId("MenuItemReviewForm-reviewerEmail").fill("sj@gmail.com");
        page.getByTestId("MenuItemReviewForm-stars").fill("5");
        page.getByTestId("MenuItemReviewForm-dateReviewed").fill("2023-10-10T00:00");
        page.getByTestId("MenuItemReviewForm-comments").fill("Great item!");
        ...
        page.getByTestId("MenuItemReviewForm-comments").fill("Not so great item!");
        page.getByTestId("MenuItemReviewForm-submit").click();

        assertThat(page.getByTestId("MenuItemReviewTable-cell-row-0-col-comments")).hasText("Not so great item!");
