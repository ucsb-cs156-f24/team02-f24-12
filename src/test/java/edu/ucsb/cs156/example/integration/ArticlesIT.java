...
public class ArticlesIT {
        ...
        public void an_admin_user_can_post_a_new_restaurant() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/articles/post?title=FirstArticle&url=https://www.google.com/&explanation=This is my first article.&email=first@ucsb.edu&dateAdded=2022-01-03T00:00:00")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
