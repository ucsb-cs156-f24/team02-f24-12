...
describe("RecommendationRequest 'Index' Page tests", () => {
  ...
  test("renders three reqs correctly for regular user", async () => {
    setupUserOnly();
    axiosMock
    ...
    const createReqButton = screen.queryByText("Create Recommendation Request");
    expect(createReqButton).not.toBeInTheDocument();
